...
// Tier metadata
// XP thresholds are set BELOW each tier's total earnable XP so players
// can always unlock the next tier by completing the current one.
// Rookie  total = 10+10+10+15 = 45 XP  → Amateur unlocks at 40 XP  ✓
// Amateur total = 25+25+30    = 80 XP  → Skilled  unlocks at 100 XP (40+80=120) ✓
// Skilled total = 50+50       = 100 XP → Advanced unlocks at 200 XP (120+100=220) ✓
// Advanced total= 100+100+120 = 320 XP → Expert   unlocks at 500 XP (220+320=540) ✓
// Expert  total = 200+200     = 400 XP → Legendary unlocks at 900 XP (540+400=940) ✓
window.TIERS = [
  { id: 1, name: 'Rookie',    icon: '🌱', color: '#10b981', minXP: 0 },
  { id: 2, name: 'Amateur',   icon: '⚡', color: '#3b82f6', minXP: 40 },
  { id: 3, name: 'Skilled',   icon: '🔗', color: '#f59e0b', minXP: 100 },
  { id: 4, name: 'Advanced',  icon: '🧠', color: '#7c3aed', minXP: 200 },
  { id: 5, name: 'Expert',    icon: '🏆', color: '#ef4444', minXP: 500 },
  { id: 6, name: 'Legendary', icon: '⚡', color: '#00d4ff', minXP: 900 },
];
